...
import 'package:syncos_android/core/utilities/domain/i_battery_info.dart';
import 'package:syncos_android/core/utilities/domain/i_device_info.dart';
...
class BatteryMonitorService implements IBatteryMonitorService {
  ...
  Future<int> getBatteryLevel() async => await _batteryInfo.getLevel();
  Future<bool> getBatteryStatus() async => await _batteryInfo.isCharging();
