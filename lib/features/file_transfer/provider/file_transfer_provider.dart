...
import 'package:syncos_android/core/network/provider/file_transfer_channel_provider.dart';
import 'package:syncos_android/core/storage/provider/file_picker_provider.dart';
...
final fileTransferServiceProvider = Provider((ref) {
  final fileService = ref.watch(filePickerProvider);
  final mainChannel = ref.watch(connectionManagerProvider);
  final transport = ref.watch(fileTransferChannelProvider);
